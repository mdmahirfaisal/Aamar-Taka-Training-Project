                        ...
                        <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 ">
                            ...
                            <div >
                                <div className="w-full relative">
                                    ...
                                    <select onChange={(e) => dispatch(handleProfessionType(e.target.value))} defaultValue={''} className="cursor-pointer form-select appearance-none block w-full pl-1 lg:pl-3 py-[11px] font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition-all ease-in-out duration-700 m-0 focus:text-gray-700 focus:bg-white focus:border-blue-900 focus:outline-none " required>
